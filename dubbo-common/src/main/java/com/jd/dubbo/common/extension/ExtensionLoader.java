...
public class ExtensionLoader<T> {
    ...
    private Class<?> getAdaptiveExtensionClass() {
        ...
        return cachedAdaptiveClass = createAdaptiveExtensioClass();
    }

    private Class<?> createAdaptiveExtensioClass() {
        String code = createAdaptiveExtensionClassCode();
        ClassLoader classLoader = findClassLoader();
        com.jd.dubbo.common.compiler.Compiler compiler = ExtensionLoader.getExtensionLoader(com.jd.dubbo.common.compiler.Compiler.class).getAdaptiveExtension();
    ...
    private String createAdaptiveExtensionClassCode() {
        ...
        for (Method method : methods) {
            ...
            Adaptive adaptiveAnnotaion = method.getAnnotation(Adaptive.class);
            StringBuilder code = new StringBuilder(512);
            if (adaptiveAnnotaion == null) {
                ...
                String[] value = adaptiveAnnotaion.value();
                ...
                for (int i = 0; i < pts.length; i++) {
                    if (pts[i].getName().equals("com.jd.dubbo.rpc.Invocation")) {
                        //null point check
